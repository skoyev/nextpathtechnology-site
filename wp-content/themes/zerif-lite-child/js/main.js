jQuery( document ).ready(function($) {
	...
	contactUsEl += '<span class="mn-icon"><i class="fa fa-user"></i></span><input type="text" class="form-control" style="text-indent:20px" name="user_name" id="user_name1" placeholder="Name" value=""></div>';
	contactUsEl += '</div><div class="mn-control-group"><div class="mn-control-label"><label for="user_email2">Email</label></div>';
	contactUsEl += '<div class="form-group"><span class="mn-icon"><i class="fa fa-envelope-o"></i></span><input class="form-control" type="text" name="user_email" style="text-indent:20px" id="user_email2" placeholder="Email" value=""></div>';
	contactUsEl += '</div><div class="mn-control-group"><div class="mn-control-label"><label for="user_subject6">Subject</label></div>';
	contactUsEl += '<div class="form-group"><span class="mn-icon"><i class="fa fa-book"></i></span><input class="form-control" type="text" name="user_subject" id="user_subject6" style="text-indent:20px" placeholder="Subject" value=""></div>';
	contactUsEl += '</div><div class="mn-control-group"><div class="mn-control-label"><label for="user_message7">Message</label></div>';
	contactUsEl += '<div class="form-group"><span class="mn-icon"><i class="fa fa-envelope"></i></span><textarea name="user_message" id="user_message7" placeholder="Message"></textarea></div>';
	...
	contactUsEl += '<input type="hidden" name="mn_save_data" id="" value="0"><div class="mn-control-group"><input class="form-control" type="submit" name="mn_contact_submit" id="mn_contact_submit" value="Submit Request" style="background-color:#0CABE5; width:100%; font-weight: bold;"></div>';
